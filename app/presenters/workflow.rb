...
class Workflow
  ...
  PRECONDITIONS = [
    ...
    { has: %i[design eubwid sign-plus], missing: %i[bwmgr-name], name: :opts },
    { has: %i[design eubwid sign-plus], missing: %i[bwmgr-phone], name: :opts },
    { has: %i[design eubwid sign-plus], missing: %i[bwmgr-email], name: :opts },

    { has: %i[design eubwid sign-plus], missing: %i[bwmgr-logo], name: :opts },
